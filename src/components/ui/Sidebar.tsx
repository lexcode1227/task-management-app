  ...
  return (
    ...
    >
      <button
        ...
        className={cn(
          "fixed -right-10 bottom-16 z-10 rounded-lg rounded-l-none bg-transparent border-color_primary_4 p-2 text-color_primary_4 transition-all duration-300 md:hidden",
        )}
      >
        {isSidebarOpen ? (
