  ...
  return (
    <article className="flex h-auto w-full flex-col items-center gap-4 rounded-lg bg-color_neutral_4 p-4 text-white">
      ...
      <div className="flex flex-col w-full gap-2">
        ...
        <h4 className="text-body-xL font-bold">Created at: {formatDate(data?.profile.createdAt)}</h4>
        <h4 className="text-body-xL font-bold">Updated at: {formatDate(data?.profile.updatedAt)}</h4>
      </div>
    </article>
  );
}
