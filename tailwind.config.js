  ...
  theme: {
    extend: {
      colors: {
        ...
        color_primary_4: "rgba(var(--primary4))",
        ...
        color_neutral_1: "rgba(var(--neutral1))",
        color_neutral_2: "rgba(var(--neutral2))",
        color_neutral_3: "rgba(var(--neutral3))",
        color_neutral_4: "rgba(var(--neutral4))",
        color_neutral_5: "rgba(var(--neutral5))",
        color_blue_1: "#2F61BF",
      },
      fontFamily: {
