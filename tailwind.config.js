  ...
  theme: {
    extend: {
      colors: {
        ...
        color_neutral_1: "rgba(var(--mainlyColor))",
        color_neutral_2: "rgba(var(--secondColor))",
        color_neutral_3: "rgba(var(--terciaryBackground))",
        color_neutral_4: "rgba(var(--secondBackground))",
        color_neutral_5: "rgba(var(--background))",
        color_blue_1: "#2F61BF",
      },
      fontFamily: {
